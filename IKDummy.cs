    ...
    public class IKDummy : MonoBehaviour {
        ...
        void Start() {
            ...
            if (PlayerTransform == null) {
                ...
                LeftHandFollow = GameObject.Find("LeftController").transform;
                RightHandFollow = GameObject.Find("RightController").transform;
            }

            leftHandDummy = SetParentAndLocalPosRot("leftDummy", transform);
            rightHandDummy = SetParentAndLocalPosRot("mixamorig:RightHand", transform);
